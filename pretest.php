...
<section id="top_content" class="top_cont_outer">
  ...
  </b> &nbsp;&nbsp; <?php echo " <img style='width:50px' src='".$dir.$image_name."'/>" ?> สวัสดีคุณ   &nbsp;&nbsp;<b><?php echo $_SESSION['ses_user']?></b>
...
$cell_data = mysql_result($result,0,0);
if($cell_data == "Old"){
	$sql_score="Select PrevScore From tb_score Where Username='".$_SESSION['ses_user']."'";
	$result_score = mysql_query($sql_score);
	$_score = mysql_result($result_score,0,0);
	
	?>
 <h2>คุณเคยทำแบบทดสอบนี้มาแล้ว  คุณได้คะแนน  &nbsp;&nbsp; <?php echo $_score ?>&nbsp;&nbsp; คะแนน</h2>
<?php
}
else{?>

<center><h1>แบบทดสอบก่อนเรียน</h1></center> 
...
<div class="formTest">
  ...
  echo '<form name="forms" id="forms" enctype="multipart/form-data" method="post" action="savescore.php">';
