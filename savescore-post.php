...
$sql1  = "UPDATE tb_history SET select_ans='$select_id1', ans='$ansId1' WHERE id = 1";
$sql2  = "UPDATE tb_history SET select_ans='$select_id2', ans='$ansId2' WHERE id = 2";
$sql3  = "UPDATE tb_history SET select_ans='$select_id3', ans='$ansId3' WHERE id = 3";
$sql4  = "UPDATE tb_history SET select_ans='$select_id4', ans='$ansId4' WHERE id = 4";
$sql5  = "UPDATE tb_history SET select_ans='$select_id5', ans='$ansId5' WHERE id = 5";
$sql6  = "UPDATE tb_history SET select_ans='$select_id6', ans='$ansId6' WHERE id = 6";
$sql7  = "UPDATE tb_history SET select_ans='$select_id7', ans='$ansId7' WHERE id = 7";
$sql8  = "UPDATE tb_history SET select_ans='$select_id8', ans='$ansId8' WHERE id = 8";
$sql9  = "UPDATE tb_history SET select_ans='$select_id9', ans='$ansId9' WHERE id = 9";
$sql10 = "UPDATE tb_history SET select_ans='$select_id10', ans='$ansId10' WHERE id = 10";
...
<section id="top_content" class="top_cont_outer">
  ...
  <center>เรากำลังพาคุณเข้าสู่หน้าหลัก</center></div>
   <?php
    $updateSQL = "UPDATE tb_score SET CurrentScore = '$score' WHERE Username = '$user'";
