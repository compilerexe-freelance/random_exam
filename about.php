...
<section class="main-section team" id="team"><!--main-section team-start-->
  <div class="container">
  </b>  <?php echo " <img style='width:50px' src='".$dir.$image_name."'/>" ?> สวัสดีคุณ   <b><?php echo $_SESSION['ses_user']?>
     <center>
    <br><br>
    <div class="flipInX wow animated"> 
		<img class="img-responsive" src="img/profileImage.jpg" alt="">
	</div>
    <br>
    <br>
   <b> <h3>นางสาววิมล    ศรีโพนทอง  <br><br>
     รหัสนักศึกษา: 5501102053008 <br><br>กลุ่ม: BC4S</h3></b>
   </center>
